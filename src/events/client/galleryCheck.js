...
module.exports = {
  ...
  async execute(message, client) {
    ...
    // if (message.content && message.content.trim().length > 0 && !message.content.match(/\S/g)) {
    ...
    //   const reminderMessage = await message.channel.send(`${message.author}, please do not send plain text messages here.`);

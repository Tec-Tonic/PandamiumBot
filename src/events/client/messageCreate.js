...
module.exports = {
  ...
  async execute(message, client) {
    ...
    for (var i in MojiraUpdateFilter) {
      if (message.content.toLowerCase().includes(MojiraUpdateFilter[i].toLowerCase()))
    ...
    if (message.channel.type === ChannelType.DM) {
      ...
      client.channels.cache.get("1095405945917550623").send({ embeds: [codeEmbed] }); //LOGS BOT SERVER
    }

...
client.on('messageCreate', (msg) =>{
  ...
  msg.embeds.forEach((embed) => {
    ...
    const joinEmbed = new EmbedBuilder().setColor('#00FF00').setAuthor({name: embed.author.name, iconURL: embed.author.proxyIconURL}).setDescription(`<t:${Math.round(message.author.createdTimestamp / 1000)}>`)
